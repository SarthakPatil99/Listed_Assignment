...
export default function Login() {
  return (
    <div>
      <div className="grid grid-cols-1 sm:grid-cols-3 h-screen w-full font-montserrat">
        <div className="col-span-1 hidden sm:flex flex-col justify-center text-center bg-stone-950 w-full h-full">
          <div className="text-white text-6xl font-bold">Board.</div>
        </div>

        <div className="col-span-2 bg-gray-100 flex flex-col justify-center text-left">
          <div className="max-w-[380px] w-full mx-auto">
            ...
            <div className="flex justify-between text-gray-500 text-xs">
              <div className="flex justify-between rounded-xl bg-white mt-3 py-2 px-5">
                ...
                <p className="ps-2">Sign in with google</p>
              </div>

              <div className="flex justify-between rounded-xl bg-white mt-3 py-2 px-5">
                <svg xmlns="http://www.w3.org/2000/svg" width="14" height="15" viewBox="0 0 12 14" fill="none">
                ...
                <p className="ps-2">Sign in with Apple</p>
              </div>
            </div>

            <form className="bg-white my-5 p-8 px-8 row rounded-2xl">
              <div className="flex flex-col text-black py-2">
                <label htmlFor="uname">User Name</label>
                <input
                  className="rounded-lg bg-gray-100 mt-2 p-2 focus:border-blue-300 focus:bg-gray-200 focus:outline-none border-none"
                  name="uname"
                  type="text"
                />
              </div>
              ...
              <div className="flex flex-col text-blue-600 pb-3">
                <p>Forget password?</p>
              </div>

              <Link to="/dashboard" type="button" className="w-full mt-3 text-white text-center py-2 rounded-lg bg-black shadow-lg shadow-gray-500/50 hover:shadow-gray-500/40">Sign In</Link>
            </form>

            <div className="flex justify-center">
              <p>Don't have an account?</p>
              <p className="ps-2 text-blue-600">Register here</p>
            </div>
          </div>
        </div>
      </div>
